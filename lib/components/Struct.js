...
var Struct = React.createClass({
  ...
  render: function () {
    ...
    t.assert(!ctx.report.maybe, 'maybe structs are not (yet) supported');
    ...
    return compile(templates.struct(new skin.Struct({
      config: config,
